...
public class UpdateCandidateControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            json.put("city",new JSONArray(city));
            ...
            cand.setCandidateId(objValues.get(0));
            cand.setCity(objValues.get(1));
            cand.setParty(objValues.get(2));
            cand.setSymbol(inp);
            boolean result=CandidateDAO.updateCandidate(cand);
            if(result)
            {
