<%-- 
    Document   : votedenied
    Created on : 12 Sep, 2021, 7:39:15 PM
    Author     : hp
--%>
    ...
    <body>
        <%
            ...
            displayBlock.append("<br/><div class='candidateprofile'><table align='center' style='color:white; font-size:25px;'><tr><td align='right'>Candidate Id:</td><td align='left'><strong>"
                 +cd.getCandidateId()+"</strong></td></tr>"
                 +"<tr><td align='right'>Candidate Name:</td><td align='left'><strong>"+cd.getCandidateName()+"</strong></td></tr>"
                 + "<tr><td align='right'> Party:</td><td align='left'><strong>"+cd.getParty()+"</strong></td></tr></table></div>");
            displayBlock.append("<div class='candidateprofile' for='"+cd.getCandidateId()+"'><br>Symbol:<br><br><img src='data:image/jpg;base64,"
                 +cd.getSymbol()+"' style='width:200px;height:200px;'/></div>");
            displayBlock.append("<div align='center'><h2 <div class='logout'><a href='login.html'>logout</a></div></div></h2><div>");
